...
namespace ProyectoWeb2MvC.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IdCliente,fecha,estado,total")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdCliente,fecha,estado,total")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
